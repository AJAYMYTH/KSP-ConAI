...
import { translateCrimeHead } from '../../i18n/utils';
...
export default function ReportsManager() {
  ...
  return (
    <div className="p-6 md:p-8 space-y-6 max-w-5xl mx-auto w-full animate-in fade-in duration-200">
      {/* Header */}
      <div>
        <span className="text-[10px] uppercase tracking-wider text-steel font-bold">{t('reports.pdfEngine')}</span>
        <h1 className="text-xl md:text-2xl font-bold text-ink-deep">{t('reports.title')}</h1>
      </div>
                ...
                >
                  <span>
                    {(() => {
                      ...
                      return selectedCase ? `${selectedCase.firNumber} - ${translateCrimeHead(selectedCase.crimeHead, currentLanguage)}` : "Select a case";
                    })()}
                  </span>
                  ...
                  <>
                    ...
                    >
                      {MOCK_CASES.map(c => (
                        ...
                        >
                          <span>{c.firNumber} - {translateCrimeHead(c.crimeHead, currentLanguage)}</span>
