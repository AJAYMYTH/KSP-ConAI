...
export default function ReportsManager() {
  ...
  const handleDownloadPdf = (item: ReportHistoryItem, e: React.MouseEvent) => {
    e.preventDefault();
    const matchCase = MOCK_CASES.find(c => c.caseId === item.caseId || c.firNumber.toLowerCase() === item.firNumber.toLowerCase());
    ...
    const summary = matchCase ? matchCase.summaryText : 'Detailed investigation report generated by KSP Crime Intelligence Copilot.';
    const accused = matchCase ? matchCase.accused.join(', ') : 'Under Investigation';
