...
// POST /reports/case/:caseId
app.post('/reports/case/:caseId', checkRole(['admin', 'investigator', 'analyst']), async (req, res) => {
...
// GET /reports/history
app.get('/reports/history', checkRole(['admin', 'investigator', 'analyst']), async (req, res) => {
  try {
