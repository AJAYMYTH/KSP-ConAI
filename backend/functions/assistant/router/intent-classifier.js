...
async function classifyIntent(text, app) {
  ...
  if (lowerQuery.includes('anomaly') || lowerQuery.includes('anomalies') || lowerQuery.includes('irregularity')) {
    return { intent: 'anomaly_detection', confidence: 'medium' };
  }

  if (lowerQuery.includes('fraud') || lowerQuery.includes('phishing') || lowerQuery.includes('cybercrime') || lowerQuery.includes('scam')) {
    return { intent: 'fraud_detection', confidence: 'medium' };
  }
  ...
  if (hasCaseIdPattern) {
    if (lowerQuery.includes('similar') || lowerQuery.includes('match')) {
