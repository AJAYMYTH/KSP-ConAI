...
const handleGraph = async (req, res) => {
...
app.get('/graph/case/:caseId', checkRole(['admin', 'investigator', 'analyst']), handleGraph);
app.get('/case/:caseId', checkRole(['admin', 'investigator', 'analyst']), handleGraph);
app.get('/:caseId', checkRole(['admin', 'investigator', 'analyst']), handleGraph);
